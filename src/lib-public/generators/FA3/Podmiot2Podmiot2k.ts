...
export function generatePodmiot2Podmiot2K(podmiot2: Podmiot2, podmiot2K: Podmiot2K): Content[] {
    ...
    firstColumn.push(createHeader(i18n.t('invoice.subject2k.identificationData')), createLabelText(i18n.t('invoice.subject2k.eori'), podmiot2.NrEORI));
    ...
    if (podmiot2.DaneKontaktowe) {
        firstColumn.push(formatText(i18n.t('invoice.subject2k.contactDetails'), [FormatTyp.Label, FormatTyp.LabelMargin]));
